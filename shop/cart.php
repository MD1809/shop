...
<?php require_once('header.php') ?>
  ...
  <main class="body_order">
    <form action="prepare_order.php" method="post">
        ...
        <?php
          if(empty($_SESSION['cart'])){
            ...
            foreach ($_SESSION['cart'] as $item) {
              ...
              <div class="cart-item">
                <div class="check">
                  <input type="checkbox" name="selected[]" value="' . $index . '" class="checkselect" checked>
                </div>
                <img src="assets/image/' . $image . '" alt="' . $name . '">
                <div class="item-details">
                  <h2>' . $name . '</h2>
                  <p>Giá: <span class="price">' . $formattedPrice . '</span></p>
                  <input type="hidden" name="items[' . $index . '][quantity]" value="' . $quantity . '" min="1">
                ...
                <div class="item-total">
                  ...
                  <a href="remove_btn.php?index=' . $index . '" class="remove-btn" onclick="return confirm(\'Bạn có chắc muốn xoá sản phẩm này?\')">Xoá</a>
                </div>
